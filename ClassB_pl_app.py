...
st.title('Kraków B Klasa Grupa 3 sezon 2023/2024 jesień')

st.markdown("""
Aplikcja pokazuje aktualną pozycję w tabeli MZPN Kraków B Klasa Grupa 3 oraz klasyfikację strzelców.

* **Biblioteki Python:** base64, pandas, streamlit, request, BeautifulSoup, highlight_text, mplsoccer
* **Dane źródłowe:** [https://www.mzpnkrakow.pl/terminarze/2023-2024/seniorzy/b_krakow_3/](https://www.mzpnkrakow.pl/terminarze/2023-2024/seniorzy/b_krakow_3/)
""")
...
with c1:
    ...
    # MZPN url website
    url = 'https://www.mzpnkrakow.pl/terminarze/2023-2024/seniorzy/b_krakow_3/'
    ...
    st.dataframe(df_slice, hide_index=True, width=650, height=465)

with c2:
    
    st.markdown("""Klasyfikacja strzelców""")
    
    df_players = pd.read_csv(r'https://raw.githubusercontent.com/MSI17819/Streamlit-Football-Table-App/main/ClassB_goals.csv',
    ...
    st.dataframe(df_selected_team, hide_index=True, width=460, height=388)

# # Open json file from github url
# with urllib.request.urlopen(r'https://raw.githubusercontent.com/MSI17819/Streamlit-Football-Table-App/main/ClassA_result_after_9.json') as url:
